      ...
      <Box sx={{ p: "40px 0px 34px 15px" }}>
        <Stack direction="column" spacing="41px" display="inline-block">
          <Stack
            direction="row"
            spacing={"5px"}
            color={page === "related" ? theme.palette.primary.main : "#000"}
            sx={{
              cursor: "pointer",
            }}
          ...
          >
            ...
            <Typography sx={TypoStyle}>Related</Typography>
          </Stack>
          <Stack
            direction="row"
            spacing={"5px"}
            sx={{
              color: page === "network" ? theme.palette.primary.main : "#000",
              cursor: "pointer",
            }}
            onClick={() => setPage("network")}
          >
            <PeopleAltIcon sx={{ fontSize: "32px" }} />
            <Typography sx={TypoStyle}>Network</Typography>
          </Stack>
        </Stack>
      </Box>
